...
- **If available:** Player and AI MUST capture opponent pieces
- **Priority:** If a capture move exists, you CANNOT make a regular non-capturing move
- **Max Capture Rule:** In International Checkers, if multiple capture paths exist, you must choose the one that captures the MAXIMUM number of pieces
